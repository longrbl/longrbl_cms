...
<style>
  ...
  #fu_image{border:1px dashed  #ccc;min-height:70px;}
  #fu_image img{margin:5px;}
</style>
<div class="admin-content">
  <div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">增加产品</strong> / <small>To increase product</small></div>
    </div>
    <hr>
    <div class="am-g">
      <div class=" am-u-md-8 ">
        <form class="am-form am-form-horizontal demoform" action="" method="post" >
          ...
          <div class="am-form-group">
            <label for="user-intro" class="am-u-sm-3 am-form-label">主图片</label>
            <div class="am-u-sm-9">
          ...
          <div class="am-form-group">
            <label for="user-intro" class="am-u-sm-3 am-form-label">副图片</label>
            <div class="am-u-sm-9">
              <button type="button" class="am-btn am-btn-secondary zjiatup">增加图片</button>
              <div style="margin-top:2px;" id="fu_image">
                <?php foreach($user['image_list'] as $v):?>
                <img src="<?php echo $v?>" height="100" width="150">
                <input type="hidden" name="image_list[]" value="<?php echo $v?>">
                <?php endforeach;?>
              </div>
</div>
          </div>
...
<script>
    ...
    KindEditor.ready(function(K) {
        ...
        K('.zjiatup').click(function() {
            editor.loadPlugin('image', function() {
                editor.plugin.imageDialog({
                    clickFn : function(url, title, width, height, border, align) {
                        K('#fu_image').append('<img src="'+url+'" height="100" width="150">');
                            K('#fu_image').append('<input type="hidden" name="image_list[]" value="'+url+'">');
                        editor.hideDialog();
                    }
                });
            });
