  ...
  <div class="admin-content-body">
    ...
    <div class="am-g">
      <div class="am-u-sm-12 am-u-md-3">
        <form class="am-form am-form-horizontal demoform" action="<?php echo base_url('admin/product/product_list')?>" method="post" >
        ...
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          ...
          <?php foreach($list as $v):?>
            <tr>
              ...
              <td><?php if($v['attribute']==1){echo '<span class="am-badge am-badge-primary">推荐</span>';}elseif($v['attribute']==2){echo '<span class="am-badge am-badge-success">热门</span>';}elseif($v['attribute']==3){echo '<span class="am-badge am-badge-warning">人气</span>';}?></td>
              <td>
                <div class="am-dropdown" data-am-dropdown="">
                  <button class="am-btn am-btn-default am-btn-xs am-dropdown-toggle" data-am-dropdown-toggle=""><span class="am-icon-cog"></span> <span class="am-icon-caret-down"></span></button>
                  <ul class="am-dropdown-content">
                    <li><a href="<?php echo site_url('/admin/product/index/'.$v['id'])?>">编辑</a></li>
