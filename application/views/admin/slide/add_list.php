...
<div class="admin-content">
  <div class="admin-content-body">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">幻灯片列表</strong> / <small>Slide list</small></div>
    </div>
    <hr>
    <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          <thead>
          <tr>
            <th>ID</th><th>标题</th><th>URL</th><th>增加时间</th><th>图片</th><th>状态</th><th>管理</th>
          </tr>
          </thead>
          ...
          <?php foreach($list as $v):?>
            <tr>
              ...
              <td><img src="<?php echo $v['imgsa']?>" width="150" height="40"></td>
              ...
              <td>
                  <div class="am-dropdown" data-am-dropdown="">
                    ...
                    <ul class="am-dropdown-content">
                      <li><a href="<?php echo site_url('/admin/slide/index/'.$v['id'])?>">编辑</a></li>
